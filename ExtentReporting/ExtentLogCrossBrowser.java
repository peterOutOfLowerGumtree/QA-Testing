...
public class ExtentLogCrossBrowser {
	...
	public void setup(String browser) {
		report = new ExtentReports("C:\\Users\\Administrator\\workspace\\JMWProject\\automationreportchrome.html", true);
		if(browser.equalsIgnoreCase("chrome")) {
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\Administrator\\Desktop\\selenium\\SeleniumFiles\\Selenium\\chromedriver.exe");
			driver = new ChromeDriver();
		} else if(browser.equalsIgnoreCase("firefox")) {
			System.out.println("Switching to Chrome");
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\Administrator\\Desktop\\selenium\\SeleniumFiles\\Selenium\\chromedriver.exe");
			driver = new ChromeDriver();
		}
	...
	public void verifyGAKFirefox() {
		driver.get("https://www.gak.co.uk");
		test = report1.startTest("Scenario 1: Verify add to basket via GAK");
		test.log(LogStatus.INFO, "Browser started");
